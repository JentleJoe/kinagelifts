                ...
                <div className="text-right">
                  <div className="space-y-2">
                    <a 
                      ...
                      className="block bg-gray-700 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition-colors font-semibold text-sm"
                    >
                      +234 810 366 4912
                    </a>
                    <a 
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 hover:bg-gray-100 transition-colors">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-800">Phone Call</h3>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Send detailed inquiry</p>
                  </div>
                </div>
                <div className="text-right">
                  <a 
                    href="mailto:kinagelifts@gmail.com" 
                    className="bg-gray-700 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition-colors font-semibold text-sm"
                  >
