    ...
    <>
      ...
      <div className="w-full max-w-7xl bg-white shadow-lg grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="p-8 md:p-12">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-heading font-extrabold text-[#1B1B1B] mb-2 uppercase">Contact Us</h2>
          <p className="text-gray-600 mb-8 text-lg">Choose your preferred way to reach us</p>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-green-600">Get instant response</p>
                  </div>
                </div>
                <div className="text-right">
                  <div className="space-y-2">
                    <a 
                      ...
                      className="block bg-green-500 text-white px-4 py-2 rounded-lg hover:bg-green-600 transition-colors font-semibold text-sm"
                    >
                      +234 810 366 4912
                    </a>
                    <a 
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 hover:bg-blue-100 transition-colors">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-blue-800">Phone Call</h3>
                    <p className="text-blue-600">Direct conversation</p>
                  </div>
                </div>
                <div className="text-right">
                  <div className="space-y-2">
                    <a 
                      ...
                      className="block bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition-colors font-semibold text-sm"
                    >
                      +234 810 366 4912
                    </a>
                    <a 
            ...
            <div className="bg-purple-50 border border-purple-200 rounded-lg p-6 hover:bg-purple-100 transition-colors">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-purple-800">Email</h3>
                    <p className="text-purple-600">Send detailed inquiry</p>
                  </div>
                </div>
                <div className="text-right">
                  <a 
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            <h3 className="text-lg font-bold text-[#1B1B1B] mb-2">Visit Our Office</h3>
