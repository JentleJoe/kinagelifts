        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl max-w-3xl mx-auto">
              Get in touch with our expert team for all your elevator and lift needs
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">info@kinagelifts.com</p>
              <p className="text-gray-600">support@kinagelifts.com</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">123 Elevator Street</p>
