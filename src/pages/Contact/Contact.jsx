      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* WhatsApp Card */}
            <div className="bg-gradient-to-br from-green-50 to-green-100 border border-green-200 rounded-xl p-8 text-center hover:shadow-lg transition-all duration-300 group">
              ...
              <h3 className="text-2xl font-bold text-green-800 mb-2">WhatsApp</h3>
              <p className="text-green-700 mb-4">Instant messaging & voice calls</p>
              <p className="text-green-600 text-sm mb-6">Average response time: 2 minutes</p>
              <div className="space-y-3">
                <a 
                  href="https://wa.me/2348103664912" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="block bg-green-500 text-white px-6 py-3 rounded-lg hover:bg-green-600 transition-colors font-semibold"
                >
            ...
            {/* Phone Card */}
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-xl p-8 text-center hover:shadow-lg transition-all duration-300 group">
              ...
              <h3 className="text-2xl font-bold text-blue-800 mb-2">Phone Call</h3>
              <p className="text-blue-700 mb-4">Direct conversation with experts</p>
              <p className="text-blue-600 text-sm mb-6">Available: Mon-Fri 8AM-6PM</p>
              <div className="space-y-3">
                <a 
                  href="tel:+2348103664912" 
                  className="block bg-blue-500 text-white px-6 py-3 rounded-lg hover:bg-blue-600 transition-colors font-semibold"
                >
                  Call Now - +234 810 366 4912
                </a>
                <button 
                  onClick={() => copyToClipboard('+2348103664912', 'phone')}
                  className="block w-full bg-blue-100 text-blue-800 px-6 py-3 rounded-lg hover:bg-blue-200 transition-colors font-semibold"
                >
            ...
            {/* Email Card */}
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 border border-purple-200 rounded-xl p-8 text-center hover:shadow-lg transition-all duration-300 group">
              ...
              <h3 className="text-2xl font-bold text-purple-800 mb-2">Email</h3>
              <p className="text-purple-700 mb-4">Detailed inquiries & documents</p>
              <p className="text-purple-600 text-sm mb-6">Response time: 24 hours</p>
              <div className="space-y-3">
                <a 
                ...
                <button 
                  ...
                  className="block w-full bg-purple-100 text-purple-800 px-6 py-3 rounded-lg hover:bg-purple-200 transition-colors font-semibold"
                >
